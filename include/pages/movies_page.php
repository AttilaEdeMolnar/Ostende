...
<script>
        function redirectToPage() {
            setTimeout(function() {
              location.href = "./?p=movies_page&id=<?php echo $id ?>";
            }, 2000);
            }
    </script>
<div class="container">
...
if(isset($_POST['own-list-button']))
{
  ...
  $sql_add = "INSERT INTO finished_movies (finished_movies_user_id, finished_movies_movies_id, finished_movies_rating, finished_movies_opinion) VALUES (".$own_value[2].", ".$own_value[3].", ".$own_value[0].", '".$own_value[1]."')";
  mysqli_query($con,$sql_add);
  ?>
  <br>
  <br>
<div class="alert alert-success">
  <?php echo "Sikeresen hozzá lett adva a saját listádhoz ez a film!"; ?>
</div>
<script>
        redirectToPage();
      </script>
...
<?php
echo $result['movies_name'];
?>
    </td>
    <td>
    <?php
echo $result['movies_director'];
?>
    </td>
    <td>
    <?php
echo $result['movies_date'];
?>
    </td>
</tr>
</table>
