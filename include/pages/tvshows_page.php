...
// $_SERVER[PHP_SELF]
$id = $_GET['id'];
$sql = "SELECT * FROM tvshows WHERE tvshows_id = '$id'";
$result = mysqli_fetch_array(mysqli_query($con,$sql));
?>
<script>
        function redirectToPage() {
            setTimeout(function() {
              location.href = "./?p=tvshows_page&id=<?php echo $id ?>";
            }, 2000);
            }
    </script>
<div class="container">
...
if(isset($_POST['own-list-button']))
{
  ...
  $sql_add = "INSERT INTO finished_tvshows (finished_tvshows_user_id, finished_tvshows_tvshows_id, finished_tvshows_rating, finished_tvshows_opinion) VALUES (".$own_value[2].", ".$own_value[3].", ".$own_value[0].", '".$own_value[1]."')";
  mysqli_query($con,$sql_add);
  ?>
  <br>
  <br>
<div class="alert alert-success">
  <?php echo "Sikeresen hozzá lett adva a saját listádhoz ez a sorozat!"; ?>
</div>
<script>
        redirectToPage();
      </script>
...
<?php
echo $result['tvshows_name'];
?>
    </td>
    <td>
    <?php
echo $result['tvshows_director'];
?>
    </td>
    <td>
    <?php
echo $result['tvshows_date'];
?>
    </td>
</tr>
</table>
